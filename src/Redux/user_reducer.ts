...
export const changeFollow = (user_id: number): FOLLOW_AC => ({type: 'FOLLOW_', id: user_id})
export const changeUnFollow = (user_id: number): UN_FOLLOW_AC => ({type: 'UN_FOLLOW_', id: user_id})
